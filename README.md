...
https://poebuildcost.com/
[크롬 확장기능](https://chromewebstore.google.com/detail/poe-build-cost/lljfbfepeepbmkgjalhcocfbobkaojof?hl=ko&authuser=0)
...
## Project Repository
[백엔드|Back-end](https://github.com/jungchanSon/pbc_b_public)
[프론트엔드|Front-end](https://github.com/jungchanSon/HelpTodo-front)
[크롬 확장기능|Chrome-Extension](https://github.com/jungchanSon/pbc_chrome_extention)
...
카카오 게임즈에서 퍼블리싱하고 있는 Path Of Exile의 빌드들의 가격을 계산해 주는 웹 서비스입니다. PoB 코드를 기반으로 빌드의 각 아이템 가격과 빌드의 총 예산을 계산해주며, 각 아이템을 거래소로 연결해줍니다.
...
Back-end
#### API
| API             | URL                  | Method   | Data Param                                                   | Succ Response                                                                                                               | Fail Response                                                         |
| --------------- | -------------------- | -------- | ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| **pobCode**     | /api/pobCode         | post     | form-data, {pobCode: string }                                | code: 200,<br>Content: [<br>objectList<br>]                                                                                 | code: 500,<br>Content: {<br>  error: "Internal Server Error"<br>}     |
| ~~searchTrade~~ | ~~/api/searchTrade~~ | ~~post~~ | ~~form-data,<br>{<br>  Query: object,<br>Sort: object<br>}~~ | ~~code:<br>200,<br>Content: {<br>  id: string,<br>complexity: int, <br>result: ArrayList(string), <br>total: int<br>}~~<br> | ~~code: 500,<br>Content: {<br>  error: "Internal Server Error"<br>}~~ |
